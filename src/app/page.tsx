        ...
        <div className="fixed inset-0 bg-black/90 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-sifter-card border border-sifter-border rounded-2xl max-w-3xl w-full p-8">
            ...
            <p className="text-gray-500 text-sm text-center mt-4">
              {isAuthenticated ? '(Changing your workflow mode)' : '(You can change this later in Settings)'}
            </p>
          </div>
        </div>
      )}
              ...
              <div className="flex items-center gap-6">
                ...
                {isLoggedIn && userMode && (
                  <div className="flex items-center gap-3">
                    <button
                      onClick={() => setShowModeModal(true)}
                      className={`px-3 py-1.5 rounded-full text-sm font-medium cursor-pointer hover:opacity-80 transition-opacity ${
